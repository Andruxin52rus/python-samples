...
class Creature():
    ...
    def attack(self, Creature):
        damage = min(Creature.hitpoints, self.damage - Creature.armor)
        Creature.hitpoints -= damage
        return damage

    def select_target(self, creatures):
        return creatures[0] if len(creatures) > 0 else None
...
class Skeleton(Creature):
    ...
    def select_target(self, creatures):
        creatures_sorted = sorted(creatures, key=lambda creature: creature.hitpoints)
...
class Orc(Creature):
    ...
    def select_target(self, creatures):
        creatures_sorted = sorted(creatures, key=lambda creature: creature.armor)
        for creature in creatures_sorted:
